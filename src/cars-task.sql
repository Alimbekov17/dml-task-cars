...
select count(*) as chevrolet_quantity from cars where brand = 'Chevrolet';
-- #7 Display the average year of manufacture of cars
select round(avg(year_of_issue)) as average_year_of_issue from cars;
...
select sum(price) as sum_of_mercedes_prices from cars where brand = 'Mercedes-Benz';
...
-- #16 Display the newest cars between 5th to 15thd
...
select *from cars where year_of_issue not between 1995 and 2005 order by year_of_issue;
